      ...
      <section className="w-full lg:w-1/2 flex flex-col justify-center items-center px-margin-mobile md:px-margin-desktop py-12 bg-surface-container-lowest">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-3 text-sm text-on-surface-variant">
              <button
              ...
              {activePolicy === 'terms' ? (
                ...
                <div className="space-y-3">
                  ...
                  <p>
                    ...
                    We retain data only as long as required for operational, legal, or security purposes.
                  </p>
                </div>
              )}
            </div>
